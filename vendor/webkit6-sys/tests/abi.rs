...
const RUST_LAYOUTS: &[(&str, Layout)] = &[
    ...
    (
        "WebKitXRPermissionRequestClass",
        Layout {
...
const RUST_CONSTANTS: &[(&str, &str)] = &[
    ...
    (
        "(gint) WEBKIT_WEB_EXTENSION_ERROR_INVALID_BACKGROUND_PERSISTENCE",
        "806",
    ),
    (
        "(gint) WEBKIT_WEB_EXTENSION_ERROR_INVALID_DECLARATIVE_NET_REQUEST_ENTRY",
        "805",
    ),
    ("(gint) WEBKIT_WEB_EXTENSION_ERROR_INVALID_MANIFEST", "802"),
    (
        "(gint) WEBKIT_WEB_EXTENSION_ERROR_INVALID_MANIFEST_ENTRY",
        "804",
    ),
    (
        "(gint) WEBKIT_WEB_EXTENSION_ERROR_INVALID_RESOURCE_CODE_SIGNATURE",
        "801",
    ),
    (
        "(gint) WEBKIT_WEB_EXTENSION_ERROR_RESOURCE_NOT_FOUND",
        "800",
    ),
    ("(gint) WEBKIT_WEB_EXTENSION_ERROR_UNKNOWN", "899"),
    (
        "(gint) WEBKIT_WEB_EXTENSION_ERROR_UNSUPPORTED_MANIFEST_VERSION",
        "803",
    ),
    (
